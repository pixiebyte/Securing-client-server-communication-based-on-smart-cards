...
public class MutualAuthenticate implements java.io.Serializable {
    ...
    } //-- jsr268gp.loader.config.MutualAuthenticate()
     ...
     */
    public static jsr268gp.loader.config.MutualAuthenticate unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (jsr268gp.loader.config.MutualAuthenticate) Unmarshaller.unmarshal(jsr268gp.loader.config.MutualAuthenticate.class, reader);
    } //-- jsr268gp.loader.config.MutualAuthenticate unmarshal(java.io.Reader) 
