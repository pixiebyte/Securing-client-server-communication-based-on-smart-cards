...
public class Load implements java.io.Serializable {
     ...
     * @return Load
     */
    public static jsr268gp.loader.config.Load unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (jsr268gp.loader.config.Load) Unmarshaller.unmarshal(jsr268gp.loader.config.Load.class, reader);
    } //-- jsr268gp.loader.config.Load unmarshal(java.io.Reader) 
